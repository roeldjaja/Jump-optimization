...
\begin{figure}[ht]
	\centering
	%      \framebox{\parbox{3in}
	{\includegraphics[width=0.5\linewidth]{initialguess}
	}%}	
...
\begin{figure*}[ht]
	...
	\caption{Optimization results. Left column: without ESB (SEA only), middle column: monoarticulated configuration, right column: biarticulated configuration. $A1$ and $A2$ denote the actuators for the ankle joint ($q_1$) and the knee joint ($q_2$), respectively.}
