...
% Large figure with all the experimental results
\begin{figure*}[ht]
	\centering
	...
	\begin{subfigure}[t]{0.32\linewidth}
		...
		\caption{No ESB: Joint tracking.}
		\label{fig:exp_noESB_joints}
	\end{subfigure}
	%
	\begin{subfigure}[t]{0.32\linewidth}
		\includegraphics[width=\linewidth]{mono/crit_high}
		\caption{Monoarticulated: Joint tracking.}
		\label{fig:exp_mono_joints}
	\end{subfigure}
	%
	\begin{subfigure}[t]{0.32\linewidth}
		\includegraphics[width=\linewidth]{bi/crit_high}
		\caption{Biarticulated: Joint tracking.}
		\label{fig:exp_bi_joints}
	\end{subfigure}
	...
	\begin{subfigure}[t]{0.32\linewidth}
		...
		\caption{No ESB: Tracking errors.}
		\label{fig:exp_noESB_joints_errors}
	\end{subfigure}
	%
	\begin{subfigure}[t]{0.32\linewidth}
		\includegraphics[width=\linewidth]{mono/q_1_torques}
		\caption{Monoarticulated: Tracking errors.}
		\label{fig:exp_mono_joints_errors}
	\end{subfigure}
	%
	\begin{subfigure}[t]{0.32\linewidth}
		\includegraphics[width=\linewidth]{bi/q_1_torques}
		\caption{Biarticulated: Tracking errors.}
		\label{fig:exp_bi_joints_errors}
	\end{subfigure}
	...
	\begin{subfigure}[t]{0.32\linewidth}
		...
		\caption{Monoarticulated: Linear tendon forces.}
		\label{fig:exp_mono_tendon_forces}
	\end{subfigure}
	%
	\begin{subfigure}[t]{0.32\linewidth}
		\includegraphics[width=\linewidth]{bi/ESB_storage}
		\caption{Biarticulated: Linear tendon forces.}
		\label{fig:exp_bi_tendon_forces}
	\end{subfigure}
	
	\caption{Experimental results. blablabla.}
