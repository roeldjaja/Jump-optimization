classdef Leg_3DoF_ACA_simulator < handle
    ...
    methods
        ...
        %__________________________________________________________________
        % Constructor
        function this = Leg_3DoF_ACA_simulator(actParamsFileName, legParamsFileName)
            % Default parameters
            ...
            % Get object model
            this.model =  Leg_3DoF_ACA(actParamsFileName, legParamsFileName);
    
            % Simulation parameters
            this.params.tspan       = [0 0.4];                   % Simulation time [s]
