% [ params ] = Leg_3DoF_design_mono()
% Parameter file for the Leg_3DoF package - Monoarticulated configuration
function [ params ] = Leg_3DoF_design_mono()

    % Define constants and parameters

    % Name for this set of parameters
    params.name     = 'Leg_3DoF_design_mono';
    ...
    params.r2       = 0.2199;           % Joint location on link 2 [m]
    params.r3       = 0.22806;          % Joint location on link 3 [m]
    ...
    params.m2       = 3.912;            % Link 2 mass [kg] (link + motors)
    params.J2       = 0.0351;           % Link 2 rot. inertia [kg m^2]

    params.m3       = 3.600;            % Link 3 mass [kg] (link + motors)
    params.J3       = 0.0350;           % Link 3 rot. inertia [kg m^2]
