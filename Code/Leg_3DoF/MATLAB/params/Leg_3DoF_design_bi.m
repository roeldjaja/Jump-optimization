% [ params ] = Leg_3DoF_design_bi()
% Parameter file for the Leg_3DoF package - Biarticulated configuration
function [ params ] = Leg_3DoF_design_bi()

    % Define constants and parameters

    % Name for this set of parameters
    params.name     = 'Leg_3DoF_design_bi';
    ...
    params.r2       = 0.21812;          % Joint location on link 2 [m]
    params.r3       = 0.21208;          % Joint location on link 3 [m]
    ...
    params.m2       = 3.196;            % Link 2 mass [kg] (link + motors)
    params.J2       = 0.0247;           % Link 2 rot. inertia [kg m^2]

    params.m3       = 4.237;            % Link 3 mass [kg] (link + motors)
    params.J3       = 0.0283;           % Link 3 rot. inertia [kg m^2]
